<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fab fa-teamspeak"></i> <span>Team</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('team.index') }}">List Team</a></li>            
              </ul>
            </li>
